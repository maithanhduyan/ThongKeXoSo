...
public class Dai {
	...
	public Dai(String ten, Date ngay, String giaiDacBiet, String giaiNhat, String giaiNhi, String giaiBa1,
			String giaiBa2, String giaiTu1, String giaiTu2, String giaiTu3, String giaiTu4, String giaiTu5,
			String giaiTu6, String giaiTu7, String giaiNam, String giaiSau1, String giaiSau2, String giaiSau3,
	...
	public String toString() {
		return "Dai{" + "ten=" + ten + ", ngay=" + ngay + ", giaiDacBiet=" + giaiDacBiet + ", giaiNhat=" + giaiNhat
